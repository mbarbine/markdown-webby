...
export default function EditorPage() {
  ...
  // ⚡ Bolt: Extracting specific properties with useShallow stops the entire
  // page from re-rendering on rapid, unrelated state changes (e.g. mouse movements
  // triggering position/hover updates in the graph).
  const { 
    viewMode, 
    fullscreen, 
    setContent, 
